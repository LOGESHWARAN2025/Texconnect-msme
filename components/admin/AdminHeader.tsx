        ...
        <div className="flex items-center space-x-2">
          ...
          {currentUser?.profilePictureUrl || currentUser?.profilePicture ? (
            <img 
              ...
              alt="Admin Avatar" 
              className="w-10 h-10 rounded-full object-cover cursor-pointer hover:ring-2 hover:ring-primary transition" 
              onClick={() => window.location.hash = 'profile'}
              title="View Profile"
            />
          ) : (
            <div 
              className="w-10 h-10 rounded-full bg-slate-200 flex items-center justify-center cursor-pointer hover:ring-2 hover:ring-primary transition"
              onClick={() => window.location.hash = 'profile'}
              title="View Profile"
            >
          ...
          <button onClick={logout} className="text-slate-500 hover:text-primary ml-2" title={t('logout')}>

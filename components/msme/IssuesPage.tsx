...
import MSMEIssuesView from './MSMEIssuesView';

interface IssuesPageProps {
  onBack: () => void;
}

const IssuesPage: React.FC<IssuesPageProps> = ({ onBack }) => {
  return (
    <div className="h-screen bg-gradient-to-br from-gray-50 to-gray-100 overflow-y-auto" style={{
      ...
      <div className="bg-white shadow-md border-b border-gray-200 sticky top-0 z-50">
        <div className="px-6 py-4 flex items-center gap-4">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Issues Tracking</h1>
        </div>
      </div>

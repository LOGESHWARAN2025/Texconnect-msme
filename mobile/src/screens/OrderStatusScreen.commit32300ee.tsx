    ...
    async function handleUpdateStatus(targetStatus: string) {
        ...
        try {
            ...
            const { error } = await supabase
                ...
                .update({ 
                    status: targetStatus, 
                    scannedunits: [], // Γ£à Reset 'BOX SCAN PROGRESS' for the next stage
                    ...
                    <table style="width: 100%; border-collapse: collapse;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="padding: 12px; border: 1px solid #e2e8f0; text-align: right; color: #475569;">Γé╣${totalAmount}</td>
                            </tr>
                        </tbody>
                    </table>
                    <div style="margin-top: 30px; text-align: right;">
                        <h2 style="color: #0f172a;">Total Paid: Γé╣${totalAmount}</h2>
                    </div>
                ...
                <View style={styles.card}>
                    ...
                    <View style={styles.infoRow}>
                        ...
                        <View style={styles.alignRight}>
                            ...
                            <Text style={[styles.itemValue, { color: '#38bdf8' }]}>Γé╣{totalAmount}</Text>
                        </View>
                    </View>
                </View>
